...
// DefNode(FunctionNode, FN_NODE_EQUATION, def_fn_equation, "EQUATION", Equation, "Equation", "")
...
DefNode(GeometryNode, GEO_NODE_EQUATION, rna_def_geo_equation, "EQUATION", Equation, "Equation", "Evaluate an Equation", "Evaluates the string input as an equation using the names of the inputs as variable")
